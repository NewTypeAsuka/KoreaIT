...
/*
 * [[ 객체란 ]]
 * 	물리적으로 존재하거나 추상적으로 생각할 수 있는 것 중에서 정의 가능하고 식별 가능한 것
 * 
 * 	예) 실제 존재하는 것 - 자동차, 휴대폰, 컴퓨터, 학생, 회원
 * 		추상적인 것 - 주문, 배송, 생산 등
 * 	모두 객체가 될 수 있다.
 * 
 * 	최소한의 프로그램 단위
 * 
 *  객체를 만들기 위해서 주형(붕어빵 틀) 또는 설계도 -> 클래스
 *  클래스에 작성된 코드를 읽어 객체화한다. -> 메모리에 올린다.
 *  
 * 클래스 구조
 *  class 클래스명 {
 *  	생성자
